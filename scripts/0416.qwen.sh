...
#SBATCH --job-name=qwen.logitlens.word
...
OUTPUT_DIR=$project_root/ishihara_out/doctor.qwen
...
declare -A MODELS=(
    ["0416.qwen.logitlens.word"]="Qwen/Qwen2.5-VL-7B-Instruct"
)

declare -A QUANTIZE_TYPES=(
    ["0416.qwen.logitlens.word"]="half"
)
