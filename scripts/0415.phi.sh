...
OUTPUT_DIR=$project_root/ishihara_out/phi
...
declare -A MODELS=(
    ["0415.phi.logitlens.number"]="microsoft/Phi-3-vision-128k-instruct"
)

declare -A QUANTIZE_TYPES=(
    ["0415.phi.logitlens.number"]=""  # Skip quantization for 'phi'
)
