...
#SBATCH --output=/cl/home2/kazuki-ha/color/log/doc_qwen_ishihara_%j.log
...
OUTPUT_DIR="/cl/home2/kazuki-ha/color/ishihara_out_doc/qwen"
...
# doctor 用のスクリプトでは quantize_type は不要なため、該当オプションは送らない
