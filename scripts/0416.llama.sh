...
#SBATCH --job-name=llama.logitlens.word
...
OUTPUT_DIR=$project_root/ishihara_out/doctor.llama
...
declare -A MODELS=(
    ["0416.llama.logitlens.word"]="meta-llama/Llama-3.2-11B-Vision-Instruct"
)

declare -A QUANTIZE_TYPES=(
    ["0416.llama.logitlens.word"]="half"
)
