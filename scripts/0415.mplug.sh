...
#SBATCH --job-name=mplug.logitlens
...
OUTPUT_DIR=$project_root/ishihara_out/mplug
...
declare -A MODELS=(
    ["0415.mplug.logitlens.number"]="mPLUG/mPLUG-Owl3-7B-240728"
)

declare -A QUANTIZE_TYPES=(
    ["0415.mplug.logitlens.number"]="half"
)
