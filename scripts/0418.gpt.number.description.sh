...
#SBATCH -t 100:00:00
#SBATCH --account=lang
#SBATCH --job-name=gpt.description
...
OUTPUT_DIR=$project_root/ishihara_out/description.gpt
PROMPT_FILE=${project_root}/data/prompts/ishihara_prompt_description_forgpt.json
