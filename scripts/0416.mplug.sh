...
#SBATCH --job-name=mplug.logitlens.word
...
OUTPUT_DIR=$project_root/ishihara_out/doctor.mplug
...
declare -A MODELS=(
    ["0416.mplug.logitlens.word"]="mPLUG/mPLUG-Owl3-7B-240728"
)

declare -A QUANTIZE_TYPES=(
    ["0416.mplug.logitlens.word"]="half"
)
