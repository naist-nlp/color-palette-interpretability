...
#SBATCH --job-name=phi.logitlens.word
...
OUTPUT_DIR=$project_root/ishihara_out/doctor.phi
...
declare -A MODELS=(
    ["0416.phi.logitlens.word"]="microsoft/Phi-3-vision-128k-instruct"
)

declare -A QUANTIZE_TYPES=(
    ["0416.phi.logitlens.word"]=""  # phiはquantize無し
)
