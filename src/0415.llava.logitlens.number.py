...
def process_images(input_data, image_dir, output_file, model, processor, prompt, device, prompt_type):
    ...
    for item in input_data:
        ...
        logitlens_dir = '/cl/home2/shintaro/color-palette-interpretability/logitlens.number.llava'
...
if __name__ == "__main__":
    ...
    process_images(input_data, args.image_dir, args.output_file, model, processor, prompt_text, args.device, args.prompt_type)
